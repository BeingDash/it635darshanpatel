	...
	<body>
		...
		<div id="page">
			...
			<ul>
				...
				<li><a href="LMS_Add_User.php"  onclick="return confirm('Do you want to leave this page and add another user?')" class="links">Add User</a><li>	
			...
			<div id="main">
				...
				<br>
				<H2>New User has been added.</H2>
				<H3>You would be able to login with those credentials.</H3>
				<br>
<!--
